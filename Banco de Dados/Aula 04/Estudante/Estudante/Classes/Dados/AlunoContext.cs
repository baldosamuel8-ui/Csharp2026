...
namespace Estudante.Classes.Dados
{
    internal class AlunoContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=ECFP507D1319379\SQLEXPRESS;Database=AlunoDB;Trusted_Connection=True;TrustServerCertificate=True");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Aluno>(entity =>
            {
                ...
                entity.Property(a => a.Cursos).HasMaxLength(50);
            }
