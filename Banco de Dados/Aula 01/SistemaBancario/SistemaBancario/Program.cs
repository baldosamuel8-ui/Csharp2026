...
using var contexto = new BancoContexto();

// Verifica se o banco de dados existe e cria se necessário
// Cria as tabelas baseadas nas entidades configuradas no DbContext
context.Database.EnsureCreated();
...
static void CadastrarConta(BancoContexto contexto)
{
    ...
    var contaExistente = contexto.Contas.FirstOrDefault(c => c.NumeroConta == numeroConta);
